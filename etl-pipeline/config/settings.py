...
class Settings:
    ...
    Attributes:
        ...
        MONGODB_COLLECTION (str): Nome da coleção para armazenar os registros.

    Security note: MONGODB_URI contém credenciais e nunca deve ser logada.
    """
    ...
    def validate(self) -> None:
        ...
        if not self.MONGODB_URI:
            raise ValueError(
                "MONGODB_URI não configurada. Defina a variável de ambiente MONGODB_URI no arquivo .env"
            )

 ...
 * @description BidCard — card de licitação do noMEI.
 *
 * Exibe:
 *  - Título da licitação
 *  - Nome do órgão público
 *  - Valor estimado formatado em BRL
 *  - Badge de status (StatusBadge)
 *  - Prazo (deadline)
 *  - Percentual de compatibilidade
 *  - Barra de progresso opcional (para tela Disputas)
 *
 * @example
 * <BidCard
 ...
 *   compatibility={95}
 *   onPress={() => navigate('DetalhesLicitacao', { bidId: '1', bidTitle: '...' })}
 * />
 */
...
export interface BidCardProps {
  ...
  /** Progresso da disputa (0-100). Mostra barra se fornecido. */
  progress?: number;
  onPress?: () => void;
